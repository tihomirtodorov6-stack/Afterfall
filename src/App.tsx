...
> = {
  command: {
    name: "COMMAND CENTER",
    icon: "🏢",
    description: "Центърът на New Hope. Определя нивото на града.",
    max: 30,
  },
  ...
  metal: {
    name: "METAL FACTORY",
    icon: "⛏️",
    description: "Добива Metal за строителство и армия.",
    max: 30,
  },
  ...
  refinery: {
    name: "REFINERY",
    icon: "🛢️",
    description: "Преработва гориво за машините и войската.",
    max: 30,
  },
  ...
  power: {
    name: "POWER PLANT",
    icon: "⚡",
    description: "Произвежда Energy за града.",
    max: 30,
  },
  ...
  warehouse: {
    name: "WAREHOUSE",
    icon: "📦",
    description: "Увеличава максималния капацитет на ресурсите.",
    max: 30,
  },
  ...
  hospital: {
    name: "HOSPITAL",
    icon: "🏥",
    description: "Увеличава капацитета за възстановяване на ранени.",
    max: 30,
  },
  ...
  barracks: {
    name: "BARRACKS",
    icon: "🪖",
    description: "Произвежда основната пехота.",
    max: 30,
  },
  ...
  vehicle: {
    ...
    icon: "🚙",
    description: "Произвежда APC и танкове.",
    max: 30,
  },
  ...
  weapons: {
    ...
    icon: "🔫",
    description: "Произвежда тежко въоръжена пехота.",
    max: 30,
  },
  ...
  research: {
    ...
    icon: "🔬",
    description: "Развива технологиите на New Hope.",
    max: 30,
  },
};
...
const researchInfo = {
  ...
  vehicles: {
    ...
    icon: "🚙",
    description: "Увеличава атаката и защитата на машините.",
  },

  production: {
    name: "PRODUCTION",
    icon: "🏭",
    description: "Ускорява производството на армия.",
  },
...
function isInfantry(type: ArmyId) {
  return [
    "recruit",
    "rifleman",
    "heavy",
...
function isVehicle(type: ArmyId) {
  return type === "apc" || type === "tank";
}
...
export default function App() {
  ...
  const [selectedBuilding, setSelectedBuilding] =
    useState<BuildingId | null>("command");
  ...
  */
  ...
  const upgradeBuilding = (
    ...
    if (
      ...
      setMessage(
        `Нужно е Command Center Level ${level + 1}.`
      );
      return;
    }
    ...
    setMessage(
      `${buildingInfo[id].name} → Level ${level + 1}`
    );
  };
  ...
  */
  ...
  const researchTech = (
    ...
    if (level >= 10) {
      setMessage("Технологията е максимална.");
      return;
    }
    ...
    window.setTimeout(() => {
      ...
      setMessage(
        `${researchInfo[type].name} → Level ${level + 1}`
      );
    }, 5000);
  };
  ...
  */
  ...
  const armyPower = useMemo(() => {
    ...
    (
      ...
      let attackValue =
        armyInfo[type].attack;

      let defenseValue =
        armyInfo[type].defense;

      if (isInfantry(type)) {
        attackValue *=
          1 +
          game.research.infantry *
            0.08;
      }
  ...
  */
  ...
  const scoutEnemy = () => {
    ...
    setMessage(
      `Разузнаването приключи. Enemy Power: ${game.enemyStrength}.`
    );
  };
  ...
  const attackEnemy = () => {
    ...
    if (won) {
      ...
      setGame((current) => ({
        ...
        battleReport:
          `ПОБЕДА! Загуби: ${casualties}. Плячка: ${lootFood} Food, ${lootMetal} Metal, ${lootFuel} Fuel.`,
      }));

      setMessage(
        "ПОБЕДА! Територията е превзета."
      );
    } else {
      const casualties =
        Math.min(
      ...
      setGame((current) => ({
        ...
        battleReport:
          `ПОРАЖЕНИЕ! Загуби: ${casualties} войници.`,
      }));

      setMessage(
        "ПОРАЖЕНИЕ. Укрепи армията си."
      );
    }
  };
...
function BuildingVisual({
  ...
  if (level <= 0) {
    return (
      <button
        className={`building ruined ${className}`}
        onClick={onClick}
      >
        <div className="ruin-icon">
          🧱
        </div>
...
function CityPanel({
    ...
    return (
      <div className="building-panel">
        ...
        <div className="production">
          ...
          {selectedBuilding === "hospital" &&
            `HOSPITAL CAPACITY +${level * 50}`}

          {selectedBuilding === "barracks" &&
            "Производство на пехота"}

          {selectedBuilding === "weapons" &&
            "Тежко въоръжение"}

          {selectedBuilding === "vehicle" &&
            "APC и Tank production"}
  ...
  return (
    <div>
      ...
      <p>
        Развивай града, произвеждай
        ресурси и създай армия.
      </p>
...
function AttackPanel({
  ...
  return (
    <div>
      ...
      <p>
        Разузнай вражеското селище
        и изпрати армията си.
      </p>
